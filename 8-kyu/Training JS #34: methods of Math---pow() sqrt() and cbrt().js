/*
  ...
  Description:
    ...
    Their usage is very simple: sqrt() returns the square root of a number; 
    ...
    Look at the example above, what's the problem? Yes, the cube root of 64 should be 4, 
    but we have not seen the 4, 
    but see 3.9999999999999996. Due to the numerical precision of JS, 
    the error will be produced in the calculation. 
    This is a problem that can't be avoided. 
    ...
    Only cubic numbers(such as 8,27,64,125,216...) 
    can be used to divide the cube evenly.
...
// Solution 1:
const cutCube = (v,n) => 
Number.isInteger(Math.cbrt(v / n)) && Number.isInteger(Math.cbrt(n));
